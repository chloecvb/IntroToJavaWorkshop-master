...
// addMouseMotionListener(this)
	...
	public void mouseMoved(MouseEvent e) {
		...
		if (mouseColor==-14495971) {
			JOptionPane.showMessageDialog(null, "You Won");}// pop up a message to tell them they won
	}
	...
	private void scare() {
		...
		AudioClip sound = JApplet.newAudioClip(getClass().getResource("Woman Screaming 2-SoundBible.com-1858551283.wav"));
